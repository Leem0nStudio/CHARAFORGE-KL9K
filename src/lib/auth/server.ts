 ...
 * It reads the Firebase ID token from the request cookies and verifies it using the Firebase Admin SDK.
 * This is the standard way to protect server actions and API routes.
 * 
