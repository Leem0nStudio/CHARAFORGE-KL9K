...
const LoraConfigSchema = z.object({
  id: z.string().describe("The ID or Alias of the LoRA model (e.g., Civitai ID or Vertex AI alias)."),
  versionId: z.string().optional().describe("The specific version ID of the LoRA to use."),
