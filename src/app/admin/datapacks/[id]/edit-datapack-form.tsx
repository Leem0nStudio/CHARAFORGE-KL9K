...
export function EditDataPackForm({ packId }: { packId: string }) {
 ...
 const handleAiSchemaGenerated = (schemaYaml: string) => {
    try {
        ...
        form.setValue('name', aiData.name || form.getValues('name'), { shouldDirty: true });
        form.setValue('description', aiData.description || form.getValues('description'), { shouldDirty: true });
        ...
        form.setValue('schema', newSchema, { shouldDirty: true });
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col">
          <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
             <TabsList>
              ...
              <TabsTrigger value="metadata" disabled={packId === 'new'}>Metadata</TabsTrigger>
              <TabsTrigger value="schema" disabled={packId === 'new'}>Schema Editor</TabsTrigger>
            </TabsList>
