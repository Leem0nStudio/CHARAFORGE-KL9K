...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Using a promise-based loading component is not ideal for the AuthProvider
  // as it needs to render its children synchronously once loading is complete.
  // The AppLogo component is a server component and cannot be directly used
  // in this client component's render-prop logic without Suspense.
  // For now, we will revert to the simple Anvil Icon which is defined locally.
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-screen w-full bg-background">
         <AppLogo iconClassName="w-24 h-24 animate-pulse-glow" />
